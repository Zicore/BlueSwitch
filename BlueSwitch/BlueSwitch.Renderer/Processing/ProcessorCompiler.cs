...
namespace BlueSwitch.Base.Processing
{
    ...
    {
        public ProcessorCompiler(RenderingEngine renderingEngine)
        {
        ...
        public void RunAll(RenderingEngine engine)
        {
            foreach (var processingTree in Items)
            {
                Run(engine,processingTree);
            }
        }


        private void BacktrackData(ProcessingNode<SwitchBase> start, ProcessingNode<SwitchBase> node, RenderingEngine renderingEngine, int layer)
        {
            layer++;
        ...
        public void Run(RenderingEngine engine, ProcessingTree<SwitchBase> processingTree)
        {
            ...
            Task.Run(() =>
            {
                ...
                try
                {
                    ...
                    do
                    {
                        processor = processingTree.Process(engine, tokenSource);
