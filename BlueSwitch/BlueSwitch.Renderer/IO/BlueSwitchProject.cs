...
namespace BlueSwitch.Base.IO
{
    ...
    public class BlueSwitchProject : JsonSerializable
    {
        ...
        public void Add(RenderingEngine engine,SwitchBase sw)
        {
            sw.Id = _currentSwitchId;
            ItemLookup.Add(_currentSwitchId, sw);
            Items.Add(sw);
            sw.Initialize(engine);
            _currentSwitchId++;
        }
        ...
        public void Initialize(RenderingEngine renderingEngine)
        {
        ...
        private void UpdateSwitches(RenderingEngine renderingEngine)
        {
